...
Diese Schutzmaßnahmen werden ausgearbeitet und begründet, aber nicht durch eigene praktische Tests belegt (siehe Abschlussbericht Kapitel 6). Zusätzlich berechnen wir den wirtschaftlichen Nutzen anhand des ROSI (Return on Security Investment) und bereiten die Ergebnisse für den Abschlussbericht auf.

## Erwartete Ergebnisse
- Beide Angriffsvektoren funktionieren reproduzierbar und sind durch Screenshots belegt (PCAPs wurden erzeugt, werden aber aus Datenschutzgründen nicht mit abgegeben)
...
- Ein vollständiger, reproduzierbarer Abschlussbericht liegt zur Abgabe vor
